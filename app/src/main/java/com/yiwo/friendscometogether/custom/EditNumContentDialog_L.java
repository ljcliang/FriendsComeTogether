...
public class EditNumContentDialog_L extends Dialog {
    ...
    CharSequence ss = "";
    public EditNumContentDialog_L(@NonNull Context context, String title, OnReturnListener listener) {
        super(context);
    ...
    private void init() {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_edit_content_num_l, null);
        setContentView(view);
