...
public class ShopAllOrderFragment extends BaseFragment {
    ...
    private FragmentShopAllOrderAdapter adapter;
    private SpImp spImp;
    private String uid = "";
    private int page = 1;
    ...
    public static ShopAllOrderFragment newInstance(int status){//status  不传或传100 全部     传1待处理  2已处理   3已完成   4退款
        Bundle args = new Bundle();
        args.putString(STATUS, status+"");
        ShopAllOrderFragment fragment = new ShopAllOrderFragment();
        fragment.setArguments(args);
        return fragment;
    }
    public View initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_shop_all_order, null);
        ...
        uid = spImp.getUID();
        mList = new ArrayList<>();
        adapter = new FragmentShopAllOrderAdapter(mList, getActivity(), new FragmentShopAllOrderAdapter.BtnsOnCLickListenner() {
            @Override
