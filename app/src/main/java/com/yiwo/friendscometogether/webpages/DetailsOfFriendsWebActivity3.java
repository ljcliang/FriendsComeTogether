...
public class DetailsOfFriendsWebActivity3 extends BaseSonicWebActivity {
...
//    TextView tvStar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_of_friends_web_3);
        ScreenAdapterTools.getInstance().loadView(getWindow().getDecorView());
        ButterKnife.bind(this);
        fmID= getIntent().getStringExtra("fmid");
        spImp = new SpImp(DetailsOfFriendsWebActivity3.this);
        uid = spImp.getUID();
    ...
    private void toComment() {
        dialog = WeiboDialogUtils.createLoadingDialog(DetailsOfFriendsWebActivity3.this,"");
                    ...
                    public void onSuccess(String data) {
                        try {
                            ...
                            if (jsonObject.getInt("code") == 200) {
                                toToast(DetailsOfFriendsWebActivity3.this, "评论成功");
...
//                                imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
                    ...
                    public void onFail(int errCode, String errMsg) {
                        comment_et_comment.setText(null);
                        WeiboDialogUtils.closeDialog(dialog);
                        toToast(DetailsOfFriendsWebActivity3.this, "评论失败："+errCode+"//"+errMsg);
                    }
                });
    }
        ...
        switch (view.getId()){
            ...
            case R.id.comment_rl_comment:
                if (TextUtils.isEmpty(comment_et_comment.getText().toString())) {
                    toToast(DetailsOfFriendsWebActivity3.this, "请输入评论内容");
                } else {
                    toComment();
                }
                break;
            case R.id.activity_details_of_friends_ll_intercalation://插文
                intent.setClass(DetailsOfFriendsWebActivity3.this, InsertIntercalationActivity.class);
                intent.putExtra("id", fmID);
                startActivity(intent);
                break;
            case R.id.activity_details_of_friends_ll_comment://评论
                if (TextUtils.isEmpty(uid) || uid.equals("0")) {
                    intent.setClass(DetailsOfFriendsWebActivity3.this, LoginActivity.class);
                    startActivity(intent);
                } else {
                    intent.setClass(DetailsOfFriendsWebActivity3.this, ArticleCommentActivity.class);
                    intent.putExtra("id", fmID);
                    startActivity(intent);
                }
                break;
                                ...
                                public void onSuccess(String data) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObject.getInt("code") == 200) {
                                            ...
                                            new ShareAction(DetailsOfFriendsWebActivity3.this).setDisplayList(SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE)
                                                    .setShareboardclickCallback(new ShareBoardlistener() {
                                                        @Override
                                                        public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                                                            ShareUtils.shareWeb(DetailsOfFriendsWebActivity3.this, shareModel.getObj().getUrl()+"&uid="+spImp.getUID(), model.getObj().getWho()+"的友记",
...
//                                                tvPraise.setTextColor(Color.parseColor("#d84c37"));
                                                ...
                                                isPraise = true;
                                                toToast(DetailsOfFriendsWebActivity3.this, "点赞成功");
                                                WeiboDialogUtils.closeDialog(dialog);
                                            }
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                            toToast(DetailsOfFriendsWebActivity3.this, "点赞失败");
                                            WeiboDialogUtils.closeDialog(dialog);
                                        }
                                    }
...
//                                                tvPraise.setTextColor(Color.parseColor("#333333"));
                                                ...
                                                isPraise = false;
                                                toToast(DetailsOfFriendsWebActivity3.this, "已取消");
                                                WeiboDialogUtils.closeDialog(dialog);
                                            }
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                ...
                                .request(new ACallback<String>() {
                                    ...
                                    public void onSuccess(String data) {
                                        try {
                                            JSONObject jsonObject = new JSONObject(data);
                                            if (jsonObject.getInt("code") == 200) {
                                                toToast(DetailsOfFriendsWebActivity3.this, "收藏成功");
                                            }
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                        }
                                ...
                                .request(new ACallback<String>() {
                                    ...
                                    public void onSuccess(String data) {
                                        try {
                                            JSONObject jsonObject = new JSONObject(data);
                                            if (jsonObject.getInt("code") == 200) {
                                                toToast(DetailsOfFriendsWebActivity3.this, "取消收藏成功");
                                            }
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                        }
...
//              {"id":"960","imgurl":"http:\/\/39.104.102.152\/uploads\/header\/2019\/03\/27\/7c2494c2f044a8011c6030e7ed75baad1553656141899.jpg","desc":""}]
            ...
            try {
                ...
                intent1.setClass(DetailsOfFriendsWebActivity3.this, ImagePreviewActivity.class);
...
//                }
        ...
        public void userinfo(String uid){
            Intent intent = new Intent();
            intent.setClass(DetailsOfFriendsWebActivity3.this, PersonMainActivity1.class);
        ...
        public void aboutactivity(String pfID){//相关活动
            ...
            intent.setClass(DetailsOfFriendsWebActivity3.this, DetailsOfFriendTogetherWebActivity.class);
            startActivity(intent);
        }
        @JavascriptInterface
        ...
        public void reportuser(String uId,String pId){//举报  评论人 的ID，评论ID
            Intent intent = new Intent();
            intent.setClass(DetailsOfFriendsWebActivity3.this, JuBaoActivity.class);
        ...
        public void jumpyouji(String fmID){
            Intent intent = new Intent();
            intent.setClass(DetailsOfFriendsWebActivity3.this, DetailsOfFriendsWebActivity3.class);
    ...
    private void showMuLuPopupwindow(View p_view) {
        ...
        View view = LayoutInflater.from(DetailsOfFriendsWebActivity3.this).inflate(R.layout.popupwindow_web_mulu, null);
        ScreenAdapterTools.getInstance().loadView(view);
        RecyclerView recyclerView = view.findViewById(R.id.rv_mulu);
        LinearLayoutManager manager = new LinearLayoutManager(DetailsOfFriendsWebActivity3.this);
...
//        // 设置popWindow的显示和消失动画
    ...
    private void showMore(final View view_p) {
        ...
        View view = LayoutInflater.from(DetailsOfFriendsWebActivity3.this).inflate(R.layout.popupwindow_detail_of_friend_web_activity_show_more, null);
...
//                getWindow().setAttributes(params);
    ...
    private void deleteYouJiOrVideo(final String type, final String delID) {// 传type 0删除游记 1删除视频  delID要删除的ID   userID登录用户的ID
        AlertDialog.Builder builder = new AlertDialog.Builder(DetailsOfFriendsWebActivity3.this);
                        ...
                        .request(new ACallback<String>() {
                            ...
                            public void onSuccess(String data) {
                                try {
                                    JSONObject jsonObject = new JSONObject(data);
                                    if (jsonObject.getInt("code") == 200){
                                        toToast(DetailsOfFriendsWebActivity3.this,"删除成功！");
                                        Intent intent = new Intent();
...
//                                        intent.setAction("android.friendscometogether.HomeFragment.TuiJian_Youji");
                                        ...
                                        toToast(DetailsOfFriendsWebActivity3.this,"删除失败："+jsonObject.getInt("code"));
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            ...
                            @Override
                            public void onFail(int errCode, String errMsg) {
                                toToast(DetailsOfFriendsWebActivity3.this,"删除失败："+errCode+"/"+errMsg);
                            }
                        });
            }
    ...
    private void startVideoACtivity(String vid,String vname,String img,String vurl){
        Intent it = new Intent(DetailsOfFriendsWebActivity3.this, VideoActivity.class);
