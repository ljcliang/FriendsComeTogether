...
public class HomeTuiJian_JingCaiLuXian_Adapter extends RecyclerView.Adapter<HomeTuiJian_JingCaiLuXian_Adapter.ViewHolder> {
    ...
    public HomeTuiJian_JingCaiLuXian_Adapter(List<HomeTuiJianModel.ObjBean.ActivityBean> data) {
        this.data = data;
    }
