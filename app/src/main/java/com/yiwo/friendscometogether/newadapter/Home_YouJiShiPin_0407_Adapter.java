...
public class Home_YouJiShiPin_0407_Adapter extends RecyclerView.Adapter<Home_YouJiShiPin_0407_Adapter.ViewHolder>{
    private Context context;
    private List<Home_youjiShiPin_0407_model.ObjBean> data;
    private SpImp spImp;
    public Home_YouJiShiPin_0407_Adapter(List<Home_youjiShiPin_0407_model.ObjBean> data){
        this.data = data;
    }
    @Override
...
//        ScreenAdapterTools.getInstance().loadView(view);
        Home_YouJiShiPin_0407_Adapter.ViewHolder holder = new Home_YouJiShiPin_0407_Adapter.ViewHolder(view);
        return holder;
    }
