...
public class ZuiXinZhaoMu_Adapter extends RecyclerView.Adapter<ZuiXinZhaoMu_Adapter.ViewHolder>{
    private Context context;
    private List<HomePageSkipListModel.ObjBean.InfoListBean> data;
    private SpImp spImp;
    public ZuiXinZhaoMu_Adapter(List<HomePageSkipListModel.ObjBean.InfoListBean> data){
        this.data = data;
    }
    @Override
