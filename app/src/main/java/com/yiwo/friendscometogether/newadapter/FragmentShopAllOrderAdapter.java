...
public class FragmentShopAllOrderAdapter extends RecyclerView.Adapter<FragmentShopAllOrderAdapter.ViewHolder> {

    private Context context;
    private List<SellerOrderModel.ObjBean> data;
    private Activity activity;
    private BtnsOnCLickListenner btnsOnCLickListenner;
    public FragmentShopAllOrderAdapter(List<SellerOrderModel.ObjBean> data, Activity activity, BtnsOnCLickListenner btnsOnCLickListenner) {
        this.data = data;
...
//                holder.tv_btn_delete.setVisibility(View.VISIBLE);
        ...
        holder.rlDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ShopOrderInfoWebActivity.start(context,data.get(position).getOrderMes());
            }
        });
