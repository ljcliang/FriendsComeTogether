...
//        ScreenAdapterTools.getInstance().loadView(view);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tv_sign.setText(data.get(position).getUserautograph());
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ImageView iv_icon,iv_level,iv_guanzhu;
        TextView tv_level,tv_name,tv_sign,tv_level_label;
        ...
        public ViewHolder(View itemView) {
            ...
            tv_level_label = itemView.findViewById(R.id.tv_level_label);
