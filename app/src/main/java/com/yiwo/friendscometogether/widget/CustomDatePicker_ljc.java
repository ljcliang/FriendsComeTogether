...
public class CustomDatePicker_ljc {

    /**
     * 定义结果回调接口
     */
    public interface ResultHandler {
        void handle(String time, Bundle bundle);
    }
    ...
    public CustomDatePicker_ljc(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.CHINA);
                handler.handle(sdf.format(selectedCalender.getTime()),bundle);
                datePickerDialog.dismiss();
            }
        });
    }
    ...
    public void show(String time,Bundle bundle) {
        if (canAccess) {
