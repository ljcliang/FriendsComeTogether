...
public class ModifyLuXIanXuXiePicAdapter extends RecyclerView.Adapter<ModifyLuXIanXuXiePicAdapter.ViewHolder> {

    private Context context;
    private List<ModifyLuXianXuXieModel.ObjBean.ImgListBean> data;
    ...
    public ModifyLuXIanXuXiePicAdapter(List<ModifyLuXianXuXieModel.ObjBean.ImgListBean> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_modify_lu_xian_xu_xie_pic, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv.setText(data.get(position).getMessage());
