...
public class ArticleCommentActivity1 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_article_comment1);
        ScreenAdapterTools.getInstance().loadView(getWindow().getDecorView());

        ButterKnife.bind(this);
        spImp = new SpImp(ArticleCommentActivity1.this);

        //注册软键盘的监听
        SoftKeyBoardListener.setListener(ArticleCommentActivity1.this,
...
//                                "键盘隐藏 高度" + height, Toast.LENGTH_SHORT).show();
    ...
    private void initData() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(ArticleCommentActivity1.this);
...
//                                        showPopupCommnet(1, id, mList.get(position).getFcID());
                                ...
                                adapter.setDeleteListener(new ArticleCommentAdapter.OnDeleteListener() {
                                    ...
                                    public void onDelete(final String id, String c) {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(ArticleCommentActivity1.this);
                ...
                .request(new ACallback<String>() {
                    ...
                    public void onSuccess(String data) {
                        try {
                            JSONObject jsonObject = new JSONObject(data);
                            if (jsonObject.getInt("code") == 200){
                                toToast(ArticleCommentActivity1.this,"删除成功");
                                initData();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                    ...
                    @Override
                    public void onFail(int errCode, String errMsg) {
                        toToast(ArticleCommentActivity1.this,"删除失败："+errCode+"/"+errMsg);
                    }
                });
        ...
        switch (view.getId()) {
            ...
            case R.id.activity_article_comment_tv_comment:
                if (TextUtils.isEmpty(etComment.getText().toString())) {
                    toToast(ArticleCommentActivity1.this, "请输入评论内容");
                } else {
                    toComment();
                }
                break;
    ...
    private void toComment() {
        if(isComment){
            dialog = WeiboDialogUtils.createLoadingDialog(ArticleCommentActivity1.this,"");
                    ...
                    .request(new ACallback<String>() {
                        ...
                        public void onSuccess(String data) {
                            try {
                                ...
                                if (jsonObject.getInt("code") == 200) {
                                    toToast(ArticleCommentActivity1.this, "评论成功");
                                    emotionMainFragment.hideEmotionKeyboard();
...
//                                imm.toggleSoftInput(0, InputMethodManager.HIDE_NOT_ALWAYS);
                        ...
                        public void onFail(int errCode, String errMsg) {
                            WeiboDialogUtils.closeDialog(dialog);
                            toToast(ArticleCommentActivity1.this, "评论失败："+errCode+"//"+errMsg);
                            etComment.setText(null);
                        }
                    });
        }else {
                    ...
                    .request(new ACallback<String>() {
                        ...
                        public void onSuccess(String data) {
                            try {
                                ...
                                if(jsonObject.getInt("code") == 200){
                                    WeiboDialogUtils.closeDialog(dialog);
                                    toToast(ArticleCommentActivity1.this, "回复成功");
                                    emotionMainFragment.hideEmotionKeyboard();
                                    etComment.setText(null);
                                    reload();
                                }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        ArticleCommentActivity1.this.finish();
    }
